...
public class FitResourceSelectionDialog extends FilteredItemsSelectionDialog {
    ...
    protected IDialogSettings getDialogSettings() {
        IDialogSettings settings = FitEditPlugin.getDefault().getDialogSettings().getSection("section");
        if (settings == null) {
            settings = FitEditPlugin.getDefault().getDialogSettings().addNewSection("section");
        }
        return settings;
    }
