...
public class FitScanner extends RuleBasedScanner {
    ...
    public FitScanner(ColorManager manager) {
        IToken defaultToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.DEFAULT)));

        IToken defaultTokenBold = new Token(new TextAttribute(manager.getColor(IFitColorConstants.DEFAULT), null,
                SWT.BOLD));

        IToken actionToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.ACTION)));

        IToken actionBoldToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.ACTION_BOLD), null,
                SWT.BOLD));

        IToken headlineToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.HEADLINE)));

        IToken headlineBoldToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.HEADLINE), null,
                SWT.BOLD));

        IToken tableToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.TABLE)));

        IToken tableBoldToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.TABLE), null, SWT.BOLD));

        IToken wordToken = new Token(new TextAttribute(manager.getColor(IFitColorConstants.WORD), null, SWT.BOLD));
        ...
        rules.add(new EndOfLineRule("```", defaultTokenBold));
