package fitnesseclipse.ui.editors.actions;
...
public class CommentTextEditorAction extends TextEditorAction {
     ...
     */
    public CommentTextEditorAction(ResourceBundle bundle, String prefix, ITextEditor editor) {
        super(bundle, prefix, editor);
    }

    /**
     * Implementation of the <code>IAction</code> prototype. Checks if the selected lines are all commented or not and
    ...
    /**
     * Implementation of the <code>IUpdate</code> prototype method discovers the operation through the current editor's
     * <code>ITextOperationTarget</code> adapter, and sets the enabled state accordingly.
     */
    @Override
    public void update() {
        super.update();
